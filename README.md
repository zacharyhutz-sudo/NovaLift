# NovaLift v0.9.1 — Satellite Roles + Orbital Network
...
# NovaLift v0.9.1 — Mobile Launchpad + Research Simplification
...
## v0.9.1 Physical Planets

- Discovered planets now appear in world view as fixed physical bodies.
- Brim, Auralis, and Vestae have their own gravity, radius, atmosphere height, and landing surface.
- The active rocket and world objects now use the strongest nearby gravity well as their primary body.
- Trajectory prediction follows the active planet around the current gravity well.
- Planet labels appear in world view after discovery.
